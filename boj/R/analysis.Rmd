...
Instead, the walkthrough is concluded by a comparison to the anlaysis of the Boj _et al_. paper which (a) did not remove the outlier and (b) did not test with respect to sex.
The most significant gene in the sleuth analysis is:
